...
\begin{figure}[h]
	...
	\centering
	\caption{Der benutzte Sensor \cite{DALLAS} \\1) Erdung 2) Datenleitung 3) Spannung}
\end{figure}
\\
...
\begin{figure}[h]
	...
	\centering
	\caption{Der benutzte Sensor \cite{HC} \\1) Spannung 2) Trigger Pin 3) Echo Pin 4) Erdung}
\end{figure} 
\\
